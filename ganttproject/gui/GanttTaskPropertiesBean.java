...
public class GanttTaskPropertiesBean extends JPanel {
  ...
  public static int Barsize1;

  public static int Barsize2;

  private JComboBox BarField;

  public String pattern[] = {"Large","Medium","Small"};
...
//    });
  ...
  public void applySettings() {
    for (int i = 0; i < selectedTasks.length; i++) {
      ...
      if(BarField.getSelectedItem()=="Large")
      {
    	  Barsize1=30;
    	  Barsize2=40;

      }
      else if(BarField.getSelectedItem()=="Small")
      {
    	  Barsize1=10;
    	  Barsize2=20;
      }
